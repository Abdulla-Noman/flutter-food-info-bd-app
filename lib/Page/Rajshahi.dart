...
class Rajshahi_Page extends StatefulWidget {
  const Rajshahi_Page({Key? key}) : super(key: key);

  @override
  _Rajshahi_PageState createState() => _Rajshahi_PageState();
}

class _Rajshahi_PageState extends State<Rajshahi_Page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Rajshahi',style: TextStyle(
          color: Colors.black,
        ),),
        centerTitle: true,
      ),
